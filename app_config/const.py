...
MULTIPLE_PROJECTS= "Multiple projects with the same name found."
...
FORKED_BUT_NOT_CLONED = "Forked successfully created but not cloned."
...
BASEDIR_HELP_MSG = "Endpoint of the repository. Default: https://git.psi.ch"
CONFIG_LIST_HELP_MSG = "List available configurations to be used"
CONFIG_HELP_MSG = "Configuration"
FORK_PROJECT_MESSAGE = "Name of the "
