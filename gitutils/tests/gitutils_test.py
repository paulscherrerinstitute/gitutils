...
class TestGitlabUtils(unittest.TestCase):
    ...
    def test_get_project_web_url(self):
        ...
        self.assertEqual(web_url, 'https://git.psi.ch/controls_highlevel_applications/app_config')
    ...
    def test_checkKey(self):
        ...
        if len(dict_projects) >= 1:
            self.assertEqual(gitlab_utils.checkKey(dict_projects[0], 'name'), True)
            self.assertEqual(gitlab_utils.checkKey(dict_projects[0], 'notKey'), False)
    ...
    def test_get_project_url(self):
        ...
        self.assertEqual(http_url_to_repo, 'https://git.psi.ch/controls_highlevel_applications/app_config.git')

    def test_get_project_id(self):
        """
        Test get_project_id
        """
        project_id = gitlab_utils.get_project_id('controls_highlevel_applications', 'app_config')
    ...
    def test_get_repo_group_names_1(self):
        ...
        """
        (repo_name, group_name, project_id, valid) = gitlab_utils.get_repo_group_names('https://git.psi.ch/controls_highlevel_applications/app_config')
    ...
    def test_get_repo_group_names_2(self):
        ...
        """
        (repo_name, group_name, project_id, valid) = gitlab_utils.get_repo_group_names('controls_highlevel_applications/app_config')
        self.assertEqual(repo_name, 'app_config')
        self.assertEqual(group_name, 'controls_highlevel_applications')
        self.assertEqual(project_id, 941)
    ...
    def test_get_repo_group_names_3(self):
        ...
        """
        (repo_name, group_name, project_id, valid) = gitlab_utils.get_repo_group_names('app_config')
        self.assertEqual(repo_name, 'app_config')
        self.assertEqual(group_name, 'controls_highlevel_applications')
        self.assertEqual(project_id, 941)
    ...
    def test_get_group_projects(self):
        ...
        """
        projects = gitlab_utils.get_group_projects('controls_highlevel_applications')
        if len(projects) >= 1:
    ...
    def test_get_owned_projects(self):
        ...
        if len(owned_projects) >= 1:
            ...
            self.assertEqual(gitlab_utils.get_username(), project.attributes['owner']['username'])
