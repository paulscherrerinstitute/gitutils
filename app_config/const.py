...
GIT_PUSH_MSG_CENTRAL_SERVER = "Pushings changes to central server and creating merge request..."
GIT_PUSH_MSG_LOCAL_SERVER = "Since there was no merge request, pushing will publish the commmits locally."
